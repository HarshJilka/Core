<?php $pages = $this->getPages(); ?>
	...
	<table border="3" width="100%" cellspacing="4">
            ...
            <tr><a href="<?php echo $this->getUrl(null,null,['p' => $this->pager->getStart()]) ?>">Start</a></tr>&nbsp; 
            <tr><a href="<?php echo $this->getUrl(null,null,['p' => $this->pager->getPrev()]) ?>">Prev</a></tr>&nbsp; 
            <tr><a href="<?php echo $this->getUrl(null,null,['p' => $this->pager->getCurrent()]) ?>">Current</a></tr>&nbsp; 
            <tr><a href="<?php echo $this->getUrl(null,null,['p' => $this->pager->getNext()]) ?>">Next</a></tr>&nbsp; 
            <tr><a href="<?php echo $this->getUrl(null,null,['p' => $this->pager->getEnd()]) ?>">End</a></tr>&nbsp; 
		<tr>
			<th>Page Id</th>
			<th>Name</th>
			<th>Code</th>
